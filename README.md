...
- V0.0.2 
- 成果一：Flet应用软件：win端，支持影刀社区版！！！暴露API供远程调用一键启动影刀机器人！！！
- 成果二：Skill技能，提供通过自然语言让Agent智能体自动操控影刀机器人功能！！！支持通过 `&key=value` 传参！
- 均适用于影刀社区免费版！！！

---

## 🆕 全新 Skill 技能 — 用自然语言操控影刀机器人！
#### 20260607史诗级上架！

- *没错！别找了！这里就是你想要的影刀 Skill ^_^*

现在你可以在 你的各类OpenClaw龙虾智能体 中通过自然语言对话来管理和控制影刀 RPA 机器人，无需手动操作界面！

#### ✨ 项目简介

本项目是一个响应当前AI新时代需求下应运而生的 **RPA Skill**，用于通过自然语言指令管理和控制本地 [影刀（ShadowBot）](https://www.yingdao.com/) RPA 机器人。
...
- 🔵 列出 / 🔍 搜索机器人 — 快速定位目标
- 🚀 启动机器人 — 自然语言说"跑一下XXX"即可，支持通过 `&key=value` 传参！
- 🛑 停止机器人 — 安全优雅停止（严禁杀进程）
- 📊 状态检测 / 📝 日志分析 — 精准了解运行情况
